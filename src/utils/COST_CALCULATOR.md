...
formatCost(0.0086, 2);   // "$0.01" (custom decimals)
```
...
**Returns:** `string` - Formatted cost (e.g., "$0.0086")
...
export const PRICING = {
  ...
  cacheRead5m: 0.30,    // USD per million tokens (5-min tier)
...
```typescript
import { parseJsonlFile } from '../server/parser.js';
